...
# Read image
image_dir = r"C:\Users\ABC\OneDrive\Desktop\cnndata\images"
output_dir = r"C:\Users\ABC\OneDrive\Desktop\receipt_bases"
...
rotate_degrees = [-3.0,-2.0, -1.0, 1.0, 2.0,3.0]
...
for img_path in image_files:
    ...
    for idx,r in enumerate(rotate_degrees):
        ...
        if rotated is not None:
            save_path = os.path.join(output_dir, f"{filename}_rot{idx}_{r}.jpg")
