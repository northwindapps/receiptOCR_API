...
crop_model_path2 = r"C:\Users\ABC\Documents\receiptYOLOProject\text_chunk_epoch40_best.pt"
crop_model_tel_date = YOLO(crop_model_path)
crop_model_all = YOLO(crop_model_path2)

crop_tel_date_results = crop_model_tel_date(source=image, conf=0.1, save=True, show=True)
crop_all_results = crop_model_all(source=image, conf=0.1, save=True, show=True)
...
for idx, jdx, total_box in all_boxes:
    ...
    # I want @170.00 170円 here, if above 5.0 consider that's not the one
    if w/h > 5.0:
